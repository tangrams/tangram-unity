...
namespace Nextzen.Unity.Editor
{
    ...
    {
        private static string kindPropertyName = "MatcherKind";

        private static string keyPropertyName = "PropertyKey";

        private static string rangeMinPropertyName = "MinRange";

        private static string rangeMaxPropertyName = "MaxRange";

        private static string regexPatternPropertyName = "RegexPattern";

        private static string valuePropertyName = "PropertyValue";
