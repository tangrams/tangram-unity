...
namespace Nextzen.Unity.Editor
{
    ...
    {
        private TreeViewState layerTreeViewState;

        private FeatureLayerTreeView layerTreeView;

        private GUIStyle labelBoldStyle;
        private GUIStyle labelItalicCenteredStyle;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (selectedLayers.Count == 1)
            {
                ...
                layer.FeatureCollection = (FeatureLayer.NextzenFeatureCollection)EditorGUILayout.EnumFlagsField("Feature Collections", layer.FeatureCollection);
        ...
        private void DrawSelectedLayer(SerializedProperty layerProperty)
        {
